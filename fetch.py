#!/usr/bin/env python3
"""
Recuperation des codes promo Lidl depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/lidl.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/lidl.fr"
STORE_NAME = "Lidl"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Lidl depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-lidl)"
    }
    try:
